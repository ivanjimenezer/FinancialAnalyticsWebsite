...
CREATE TABLE `otrosingresos` (
  ...
  `IngresosTipos` varchar(30) DEFAULT NULL,
...
INSERT INTO `otrosingresos` VALUES (1,'Renta',871),(2,'Inversiones',227),(3,'Otros Ingresos',8460);
...
-- Dump completed on 2023-11-15 20:08:26
